...
var Link = function (_Component) {
	...
	_createClass(Link, [{
		...
		value: function render() {
			...
			var isActive = false;
			if (this.routeInfo.routePath === _route2.default.current.routePath) {
				isActive = true;
			}
			...
			var actName = isActive ? activeClassName : '';
			...
			return _react2.default.createElement(
				'a',
				_extends({ className: (0, _classnames2.default)(actName, className), href: href, onClick: this.onClick.bind(this, href) }, props),
				children
			);
		}
	}]);
