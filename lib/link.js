...
var Link = function (_Component) {
  ...
  _createClass(Link, [{
    ...
    value: function componentWillUnmount() {
      this.unmount = true;
      _route2.default.off(_constant.ROUTER_CHANGE_FINISH_EVENT, this.onChange);
    }
  }, {
    ...
    value: function componentDidMount() {
      ...
      _route2.default.on(_constant.ROUTER_CHANGE_FINISH_EVENT, this.onChange);
    }
  }, {
    ...
    value: function onClick(href, e) {
      ...
      if (_route2.default.routeConfig.type !== _constant.ROUTER_TYPE_KEY_HISTORY) {
        return;
      }
